...
def load_weights(weight_file):
    ...
    try:
        ...
        print('Load model weights with bytes-encoding scheme ...')
...
class KitModel(nn.Module):
    ...
    def __init__(self, weight_file):
        ...
        self.conv1_7x7_s2 = self.__conv(2, name='conv1/7x7_s2',
                                        in_channels=3, out_channels=64,
                                        kernel_size=(7L, 7L), stride=(2L, 2L),
                                        groups=1, bias=False)
        self.conv1_7x7_s2_bn = self.__batch_normalization(2, 'conv1/7x7_s2/bn',
                                                          num_features=64,
                                                          eps=9.99999974738e-06,
                                                          momentum=0.0)
        self.conv2_1_1x1_reduce = self.__conv(2, name='conv2_1_1x1_reduce',
