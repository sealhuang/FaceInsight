...
class MTCNNDetector(object):
    ...
    def infer(self, image, min_face_size=20.0,
        ...
        Returns:
            two float numpy arrays of shapes, one contains bounding boxes and
            the confidence (shape [n_boxes, 5]), and the other contains
            facial landmarks (shape [n_boxes, 10]).
        """
